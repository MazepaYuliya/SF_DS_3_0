...
* [Очистка данных](./Data_cleaning.ipynb)
...
* [Очистка данных: прогнозирование диабета](./tasks/diabetes.ipynb)
* [Визуализация: анализ потребления солнечной энергии](./tasks/solarpower.ipynb)