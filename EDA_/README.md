...
* [Разведывательный анализ](./eda.ipynb)
* [Библиотеки для EDA](./eda_libraries.ipynb)
* [Описательная статистика](./eda_descriptive_statistics.ipynb)

## Feature Engineering

* [Проектирование и отбор признаков](./feature_design.ipynb)
...
* [Проектирование признаков на данных о болезнях сердца](./tasks/eda_heart.ipynb)
* [Проверка статистических гипотез на данных о размерах пицц](./tasks/pizzas.ipynb)
